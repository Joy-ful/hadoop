...
public class combineToSequenceFile {
    public static void main(String[] args) throws IOException {
        //combineToSequenceFile();
        //combineToSequenceFile();
    ...
    private static void combineToSequenceFile() throws IOException {
        String sourceDir = "/test/test.txt";
        String destFile = "/test/test2";
